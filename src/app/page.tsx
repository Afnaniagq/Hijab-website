import Image from "next/image";
  ...
  <Image     src="/top.webp" alt="hijab" width={1500} height={1200} className="  border-black  " ></Image> 
      ...
      <div className="max-w-[1320px] mx-auto">
        <div className="flex md:flex-row flex-col">
          ...
          <div  className="basis-[45%]  rounded-lg md:order-2 order-1 p-[20px] group">
            <Image className="hover:translate-y-4 duration-[2s] rounded-xl border-black"   src="/scarf.jpg" alt="hijab" width={550} height={500}></Image>
    ...
    <div  className="basis-[55%] md:order-2 order-1 px-[50px]">
     ...
     <section className="bg-black  size-auto grid lg:grid-row-auto flex-wrap">
           ...
           <div className="max-w-[1170px] mx-auto grid grid-cols-1 md:grid-cols-[40%_auto] gap-[30px] flex-wrap">
            ...
            <li>FAQs</li> 
             ...
             <div  className="basis-[45%] md:order-2 order-1 p-[20px] ">
             ...
             <div className="pl-80 pt-14">
              <p className=" text-[15px] md:text-[20px] text-white hover:text-blue-600 font-mono text- pr-10 ">Copyright © 2024, HijabCorner </p>
             </div>
           </div>
           </div>
          </section>
